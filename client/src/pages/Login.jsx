...
export const Login = () => {
  const [activePortal, setActivePortal] = useState('CUSTOMER'); // 'CUSTOMER' | 'VENDOR' | 'ADMIN' | 'SUPER_ADMIN'
  ...
  const portals = [
    { id: 'CUSTOMER', label: 'Customer', icon: ShoppingBag, desc: 'Shopping & Rewards', path: '/customer/login' },
    ...
    <div className="min-h-[88vh] flex items-center justify-center px-4 py-12 bg-gradient-to-b from-blue-50/50 via-slate-50 to-white">
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-slate-500 mt-1">Select your designated portal to sign in</p>
        </div>
